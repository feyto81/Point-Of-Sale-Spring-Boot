...
public class Carts {
    ...
    public Carts(String customer, Integer qty, String transaction_code, String id_users, Items item_idd, String created_at, String discount,Integer price,String total,String item_id1) {
